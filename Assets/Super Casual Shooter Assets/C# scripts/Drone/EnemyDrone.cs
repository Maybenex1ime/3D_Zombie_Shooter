...
public class EnemyDrone : MonoBehaviour
{
    ...
    public void onDeath() // when drone runs out of health, this function basically simulates the destruction of the drone when dead
    {
        ...
        // before we destry the object, let us add convex mesh colliders and rigid bodies to the child transforms to simulate destruction like the drone broke to pieces
