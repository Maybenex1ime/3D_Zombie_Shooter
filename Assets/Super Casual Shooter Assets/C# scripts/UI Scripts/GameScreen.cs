...
public class GameScreen : MonoBehaviour
{
    ...
    [SerializeField] private Text health_percent_text;
    ...
    protected void updateHealthUI()
    {
       // fill bar based on health
        ...
        health_percent_text.text = "Health --> " + ((float)player_damagable.getCurrentHealth() / (float)player_damagable.getMaxHealth() * 100).ToString("n0") + " %";
    }
